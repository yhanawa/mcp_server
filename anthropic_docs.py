...
# リポジトリの初期化
docs_repository = DocsRepository("document/anthropic_docs.json")
...
@mcp.tool("getDocument_anthropic")
...
# ツール: インデックスでドキュメント取得
@mcp.tool("getDocumentByIndex_anthropic")
...
# ツール: ドキュメント検索
@mcp.tool("searchDocuments_anthropic")
